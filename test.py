...
test_dataset = GTSRBTestDataset(
    csv_file='/content/drive/MyDrive/APS360/Project/Test.csv',
    root_dir='/content/drive/MyDrive/APS360/Project/Test',
    transform=transform,
...
test_accuracy, top_1_error_rate = test_model(model, test_loader)
